...
class config{
	 ...
	 public  $localhost = "localhost";   //your host name if using xampp...should be same
      public  $user = "root";         //username of database to access it.....should be same
	  public  $password = "";        //password for xampp if the user is created...should be same
	  public  $dbname = "onlinevotingsystem";    //this is the database name.....try to create a DB of this name and import DB in the ZIP file
	  public  $con;
	...
	{ 
		...
		$set_base_url = "/votingsystem/";                                           // set base url....or the folder name inside "htdocs" folder mine was this
		$server_host = "http://".$_SERVER['HTTP_HOST'].""; //use http/https as per your server...my server has tls certifications installed that's why i use https
