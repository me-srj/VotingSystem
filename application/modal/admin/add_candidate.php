...
$password=mysqli_escape_string($call_config->con,$_POST['password']);
	if ($cname!=null && $cname!=""&&$password!=null && $password!=""&&$username!=null && $username!="") 
	{
    $sql="INSERT INTO `tbl_candidates_master`(`candidate_name`, `username`, `password`) VALUES ('".$cname."','".$username."','".md5($password)."')";	
